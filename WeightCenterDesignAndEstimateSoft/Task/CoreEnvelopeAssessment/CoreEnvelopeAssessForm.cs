    ...
    public partial class CoreEnvelopeAssessForm : Form
    {
        ...
        public void saveCoreGridView(List<CorePointExt> cpdList, string flag)
        {
            ...
            else if (flag == "1")
            {
                ...
                this.coreAssessResult.topMarginMin = 0.05;
                this.coreAssessResult.topMarginMax = 0.1;
                this.coreAssessResult.downMarginMin = 0.9;
                this.coreAssessResult.downMarginMax = 0.95;
            }
            else
            {
                MessageBox.Show("数据问题");
                return;
            }
